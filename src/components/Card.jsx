...
const Card = () => {
  ...
  const { products, handleName } = useContext(ProductContext)
    ...
    <div className='flex flex-wrap justify-center'>
      ...
      {products
        ...
        .map((item) => (
          ...
          <div
            key={item.id}
            className="relative m-10 w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-md hover:scale-105 ease-in-out">
            ...
            <div className="mt-4 px-5 pb-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300 cursor-pointer">
